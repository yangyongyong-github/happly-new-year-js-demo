...
var page2 = {
  ...
  render: function () {
    ...
    // 预先设置好状态
    this.doms.desc.innerText = `你可以录制${this.sound.maxSeconds}秒的音频`;    // 设置提示文本
    this.doms.number.innerText = "";    // 设置剩余时间为不显示

    if (this.sound.status === "no-voice") {    // 状态为：「没有录音」时的各种情况
